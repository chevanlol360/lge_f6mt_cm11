...
/* LGE_CHANGE [younglae.kim@lge.com] 2013-02-20
 * modify maximum retry count for i2c access to make the system can be booted up
 * even though sensor chipset is not working properly.
 */
