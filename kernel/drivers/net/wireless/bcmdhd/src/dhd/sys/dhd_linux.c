 ...
 *
 * $Id: dhd_linux.c 460224 2014-03-06 11:18:22Z $
 */
...
#ifdef LGE_HOTSPOT_VZW_NODE_ENABLE
	op_mode = 0;
#endif // _E
...
#endif /* defined(USE_INITIAL_2G_SCAN) || defined(USE_INITIAL_SHORT_DWELL_TIME) */
...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	if ((!op_mode && strstr(fw_path, "_mfg") != NULL) ||
		...
		DHD_ERROR(("%s : Set IOCTL response time.\n", __FUNCTION__));
	}
