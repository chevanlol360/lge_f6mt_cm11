...
int res_trk_update_bus_perf_level(struct vcd_dev_ctxt *dev_ctxt, u32 perf_level)
{
	...
	bool turbo_supported =
		!resource_context.vidc_platform_data->disable_turbo;
	/* LGE_CHANGE_S, QCT SR#01173613 higher_bus.patch, prevent FHD rec fail, 2013-07-08, yoongeun.kwon@lge.com */
	int higer_bus_bw =
	   resource_context.vidc_platform_data->vote_high_bw;
	/* LGE_CHANGE_E, QCT SR#01173613 higher_bus.patch, prevent FHD rec fail, 2013-07-08, yoongeun.kwon@lge.com */
