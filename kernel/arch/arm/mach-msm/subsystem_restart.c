...
//[LGE_CHANGE_S] display modem crash debug infomation, 2013-04-02, donghyuk.yang@lge.com
#define LGE_BSP_MODEM_CRASH_DISPLAY

#ifdef LGE_BSP_MODEM_CRASH_DISPLAY
#define MODEM_SUBSYSTEM "modem"
#endif // LGE_BSP_MODEM_CRASH_DISPLAY
//[LGE_CHANGE_E] display modem crash debug infomation
