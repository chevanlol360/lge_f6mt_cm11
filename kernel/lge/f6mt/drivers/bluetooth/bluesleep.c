...
//ADD: 0019639: [F200][BT] Support Bluetooth low power mode
    ...
    {
//BT_S : [PSIX-6869] LPM_SLEEP_MODE_DO_NOT_UART_CLOSE
        BT_DBG("In case of MSM8930 do not uart close. UART dirver will close UART automatically");
//BT_E : [PSIX-6869] LPM_SLEEP_MODE_DO_NOT_UART_CLOSE
    }
#endif/*CONFIG_LGE_BLUESLEEP*/
//END: 0019639 chanha.park@lge.com 2012-06-16
...
//BT_S : [PSIX-6869] MSM8930 do not uart close
    if (proto == '0' || proto == '2')
        bluesleep_stop();
//BT_E : [PSIX-6869] MSM8930 do not uart close
    else
        bluesleep_start();
