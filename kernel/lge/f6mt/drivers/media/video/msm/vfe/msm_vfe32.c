...
/*LGE_CHANGE_S, to check if frame is comming, 2013-01-28, kwangsik83.kim@lge.com*/
static int countSOF = 0;
static int outputPath_irq0 = 0;
static int outputPath_irq1 = 0;
/*LGE_CHANGE_E, to check if frome is comming, 2013-01-28, kwangsik83.kim@lge.com*/
...
#if 0 /* LGE_CHANGE_S, fixed for VFE overflow 2014-03-09 grant.kang@lge.com */
...
#endif /* LGE_CHANGE_E, fixed for VFE overflow 2014-03-09 grant.kang@lge.com */
...
#if 1 /*LGE_CHANGE, Return to LGE Recovery, 2013-08-26, soojong.jin@lge.com */
...
/*LGE_CHANGE_S, camera recovery from GK, 2013-02-15, soojong.jin@lge.com */
...
/*LGE_CHANGE_E, camera recovery from GK, 2013-02-15, soojong.jin@lge.com */
	if (!axi_ctrl->share_ctrl->vfebase) {
		pr_err("%s: base address unmapped\n", __func__);
/*LGE_CHANGE_S, camera recovery from GK, 2013-02-15, soojong.jin@lge.com */
#ifdef LGE_GK_CAMERA_BSP
