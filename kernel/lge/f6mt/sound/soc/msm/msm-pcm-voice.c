...
/* [FX3 AUDIO_BSP] SPCS&MPCS Voice call Volume level is 7 steps */
...
// LGE_CHANGE_S, 2013-04-03, cheolyong.yu@lge.com, VZW call volume level is 8 steps
#elif defined(CONFIG_MACH_LGE_FX3_VZW) 
static struct snd_kcontrol_new msm_voice_controls[] = {
	SOC_SINGLE_EXT("Voice Rx Device Mute", SND_SOC_NOPM, 0, 1, 0,
				msm_voice_rx_device_mute_get,
				msm_voice_rx_device_mute_put),
...
// LGE_CHANGE_S, 2013-04-03, cheolyong.yu@lge.com, VZW call volume level is 8 steps
// LGE_CHANGE_S, 2013-07-12, dana.park@lge.com, TMUS call volume level is 7 steps
...
// LGE_CHANGE_E, 2013-07-12, dana.park@lge.com, TMUS call volume level is 7 steps
